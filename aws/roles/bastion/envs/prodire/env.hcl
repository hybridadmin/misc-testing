...
#
# Multi-account deployment: targets multiple OUs via generate_account_dirs.sh.
# Each account in those OUs gets its own leaf directory with an account.hcl
# override for account_id.
# -----------------------------------------------------------------------------
...
locals {
  ...
  # S3
  project_bucket_arn      = "arn:aws:s3:::devops-prodire-project-bucket"
  project_bucket_name     = "devops-prodire-project-bucket"
  authorized_users_bucket = "moya-internal"

  # DNS / Route53
  hosted_zone_id = "Z00000000000000000000"
  route53_zone_ids = [
    "Z00000000000000000000",  # prodire hosted zone
  ...
  # -----------------------------------------------------------------------
  # Multi-account target OUs and regions
  # Used by scripts/generate_account_dirs.sh to scaffold per-account dirs
  # -----------------------------------------------------------------------
  target_ou_ids = [
