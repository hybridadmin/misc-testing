...
locals {
  ...
  #   envs/<environment>/<region>/root_audit_trail/terragrunt.hcl              (single account)
  #   envs/<environment>/<region>/<account_id>/root_audit_trail/terragrunt.hcl (multi-account)
