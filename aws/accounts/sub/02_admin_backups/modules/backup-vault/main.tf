...
# -----------------------------------------------------------------------------
# Account guard: ensure this module is only applied in the backups account
# -----------------------------------------------------------------------------
resource "terraform_data" "account_guard" {
  lifecycle {
    precondition {
      condition     = data.aws_caller_identity.current.account_id == var.backup_account_id
      error_message = "This module must only be applied in the backups account (${var.backup_account_id}). Current account: ${data.aws_caller_identity.current.account_id}."
    }
  }
}
