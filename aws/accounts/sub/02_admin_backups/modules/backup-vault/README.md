...
> **Account guard:** This module includes a precondition that validates the current AWS account matches the `backup_account_id` input. If applied against the wrong account, Terraform will fail with an error before creating any resources.
