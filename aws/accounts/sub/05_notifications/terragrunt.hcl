...
locals {
  ...
  #   envs/<environment>/<region>/notifications/terragrunt.hcl              (single account)
  #   envs/<environment>/<region>/<account_id>/notifications/terragrunt.hcl (multi-account)
  ...
  # For single-account envs, account_id comes from env.hcl.
  # For multi-account envs, each account dir has an account.hcl with its own account_id.
