###############################################################################
# Workload Staging Account — SSO Account Assignments
###############################################################################
...
locals {
  staging_account_id = "333333333333" # <-- REPLACE with your staging account ID
}
...
inputs = {
  account_assignments = [
    ...
    # Developers get developer access (same as dev for staging)
    {
      account_id          = local.staging_account_id
